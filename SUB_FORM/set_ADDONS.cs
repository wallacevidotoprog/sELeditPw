...
namespace sELedit.NOVO
{
	public partial class set_ADDONS : Form
	{
		...
		{
			_wepon = sELeditCache.Instance.sELeditDatas.database._wepon;
			_armor = sELeditCache.Instance.sELeditDatas.database._armor;
			_decoration = sELeditCache.Instance.sELeditDatas.database._decoration;
			_suite = sELeditCache.Instance.sELeditDatas.database._suite;
