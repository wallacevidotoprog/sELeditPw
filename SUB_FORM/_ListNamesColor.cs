...
namespace sELedit.NOVO
{
	public partial class _ListNamesColor : Form
	{
		...
		{
			if (sELeditCache.Instance.sELeditDatas.database.item_color.ContainsKey(idItem))
			{
				sELeditCache.Instance.sELeditDatas.database.item_color.Remove(idItem);
				sELeditCache.Instance.sELeditDatas.database.item_color.Add(idItem, listBox_names.SelectedIndex);
