...
//		{
//            if (sELeditCache.Instance.Settings == null) return;

//			try
//            {

//                if (sELeditCache.Instance.Settings.CheckFileExists(nameof(sELeditCache.Instance.Settings.ConfigPckPath)))
//                {
//                    item_color = new SortedList<int,int>();
//                    pck = new PCKs(sELeditCache.Instance.Settings.ConfigPckPath);
